...
### `RNLachrom()`
For achromatic contrast calculation (single photoreceptor), use the \code{RNLachrom} function:
...
Model output provides photoreceptor noise (e), the relative quantum catches (Qr), photoreceptor outputs (E), and the achromatic distance (deltaS) of the first stimulus in relation to the second stimulus (against the background when `R1=Rb`).
